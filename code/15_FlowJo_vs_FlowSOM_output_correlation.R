#Loading of the data
setwd("MY PATH")
data <- read.xlsx("data_FlowJo_vs_FlowSOM.xlsx", sheetName = "rmcorr")
...
ggplot(data, aes(x = FlowJo , y = FlowSOM, color = Celltype, group = Celltype)) + 
...
ggplot(data, aes(x = log10.FlowJo, y = log10.FlowSOM, color = Celltype , group = Celltype )) + 
